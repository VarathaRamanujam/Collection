...
//	        try {
		 TreeSet ts=new TreeSet(new MyComparator_Class());
		//TreeSet ts = new TreeSet();
		/*
		 * ts.add(3); ts.add(100); ts.add(300); ts.add(1100); ts.add(37); ts.add(1200);
		 */
...
//			ts.add("hii");
		  ...
		  ts.add(new Students_obj("Arun",27,45,"b.Tech-mech")); 
		  ts.add(new Students_obj("Arus",25,25,"b.Tech-mech"));
